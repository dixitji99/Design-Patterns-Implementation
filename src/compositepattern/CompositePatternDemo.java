...
public class CompositePatternDemo {
	public static void main(String args[]) {
		Employee emp1 = new Cashier(101, "Salman Khan", 20000.0);
		Employee emp2 = new Cashier(102, "Mahesh Babu", 25000.0);
		Employee emp3 = new Accountant(103, "Varun Dhawan", 30000.0);
		Employee manager1 = new BankManager(100, "Allu Irish", 100000.0);
